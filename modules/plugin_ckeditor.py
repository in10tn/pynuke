...
class CKEditor(object):
    ...
    def define_tables(self, migrate=True, fake_migrate=False):
        ...
        self.settings.table_upload = self.db.define_table(upload_name,
            ...
            Field('upload','upload',uploadfolder=request.folder +'static/uploads/' ),
    ...
    def handle_upload(self):
        ...
        path = os.path.join(current.request.folder,'static', 'uploads')
    ...
    def load(self, selector=None, use_caching=True):
        ...
        contents_css = "['%s', '%s', '%s']" % (URL('static', 'plugin_ckeditor/base.css'), URL('static', 'plugin_ckeditor/contents.css'), URL('static', 'css/bootstrap.min.css'))
